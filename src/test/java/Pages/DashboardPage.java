...
import static Utilities.RandomGenerator.randomString;

public class DashboardPage extends PageObject {
    String product_name,descriptiontext="";

    String product_price,compare_at_price,product_sku,product_barcode="";
    ...
    @FindBy(xpath="//p[text()='Product was created successfully. What’s next?']")
...
//    public org.openqa.selenium.By verify_random_productname() {
//        return By.xpath("//button[text()="+product_name+"]");
//    }


    String filePath= new File(".").getCanonicalPath()+"\\src\\test\\resources\\testData\\product.jpg";
    String corrupted_filePath= new File(".").getCanonicalPath()+"\\src\\test\\resources\\testData\\corrupted_image.png";
...
//        Thread.sleep(1000);
    ...
    public void fill_form() throws InterruptedException, ConfigurationException {
        ...
        withTimeoutOf(40, TimeUnit.SECONDS).waitFor(description).waitUntilClickable();
    ...
    public void chooseFileToUpload() throws InterruptedException {
        add_image.click();
        waitABit(500);
...
//        compare_price.sendKeys("200");
        sku.sendKeys("1000");
        barcode.sendKeys("2000");
        submit_button.click();
        Thread.sleep(3000);
...
//        not
        ...
        public void verifySuccessMessage() {
            waitFor(success_message).withTimeoutOf(2,TimeUnit.SECONDS);
        Boolean result=success_message.isDisplayed();
    ...
    public void verifyfailureMessage() {
        waitFor(corrupt_image_failure_message).withTimeoutOf(30,TimeUnit.SECONDS);
        Boolean result=corrupt_image_failure_message.isDisplayed();
        System.out.println(result);
    }

    public void Upload_corrupted_file() throws InterruptedException {
        add_image.click();
        waitABit(500);
        StringSelection stringSelection = new StringSelection(corrupted_filePath);
        Clipboard clipboard = Toolkit.getDefaultToolkit().getSystemClipboard();
        clipboard.setContents(stringSelection, null);
        Robot robot = null;
