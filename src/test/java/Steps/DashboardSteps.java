...
public class DashboardSteps {
    ...
    public void i_Go_To_Add_Product_Page_And_Fill_All_Fields_And_Click_On_Submit() throws InterruptedException, ConfigurationException, InterruptedException, IOException {
        ...
        dashboardPage.uploadallowedimage();
...
//        dashboardPage.verify_approved_products();

    }


    @When("^I go to add product page and add a corrupt image in add product page and click on submit$")
    public void  I_go_to_add_product_page_and_add_a_corrupt_image_in_add_product_page_and_click_on_submit() throws InterruptedException, ConfigurationException, InterruptedException, IOException {
        dashboardPage.click_on_product();
        dashboardPage.addproductbutton();
        dashboardPage.select_product_dropdown();
        dashboardPage.fill_form();
        dashboardPage.uploadcorruptedimage();
    }
